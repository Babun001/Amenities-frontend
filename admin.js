...
document.getElementById("addTabForm").addEventListener("submit", async (e) => {
    ...
    try {
        const res = await fetch("https://amenities-backend-production.up.railway.app/api/add-tab", {
            method: "POST",
            headers: {
...
async function loadTabs() {
    try {
        const res = await fetch("https://amenities-backend-production.up.railway.app/api/tabsData");
...
document.getElementById("deleteTabForm").addEventListener("submit", async (e) => {
    ...
    try {
        const res = await fetch("https://amenities-backend-production.up.railway.app/api/delete-tabs", {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `BabunRoy ${token}`
